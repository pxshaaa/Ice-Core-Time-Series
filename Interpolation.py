...
from PyQt5.QtWidgets import QPushButton, QLabel, QComboBox, QGroupBox, QGridLayout, QVBoxLayout, QFileDialog, QApplication,QHBoxLayout,QDesktopWidget,QWidget,QLineEdit,QFrame
